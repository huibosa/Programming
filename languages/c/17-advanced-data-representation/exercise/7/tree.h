...
/*                  tree and returens trues; otherwise, */
...
/* operation:       find the location of an item in the */
/*                  tree                                */
/* preconditions:   pi points to an item                */
/*                  ptree points to an initialized tree */
/* postconditions:  a pointer to the item to            */
/*                  corresponding to the item pointed   */
/*                  by pi is returned                   */
/*                  return NULL pointer if no match is  */
/*                  found                               */
